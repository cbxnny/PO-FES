      ...
      <main className="qut-content">
        ...
        <div className="feedback-form-container">
          <section className="qut-card feedback-intro-card">
            ...
            <p>
              This feedback item is formative and is not directly marked. However, keeping an accurate record of meetings with the project owner is a mandatory part of the unit and helps verify the team’s progress and performance.
            </p>
            <p>
              Feedback should be completed at least fortnightly and should be based on the team’s progress since the previous meeting.
            </p>
            <p>
              If the team receives a Below Expectations rating, written comments must be provided so the issue can be discussed in the next tutor meeting.
            </p>
          </section>
            ...
            <section className="qut-card">
              ...
              <div className="qut-field">
                ...
                <textarea
                  ...
                  placeholder="Provide any feedback about the team’s progress, communication, teamwork, technical work, goals, attendance, or anything that should be discussed in the next tutor meeting."
                  value={teamComment}
              ...
              <div className="qut-form-stack">
                {teamMembers.map((student) => (
                  <div className="qut-info-box" key={student}>
                    ...
                    <div className="qut-field">
                      <label htmlFor={`score-${student}`}>Individual Rating</label>
                      <select
                        id={`score-${student}`}
                        className="qut-input"
